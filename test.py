...
def decode_audio(audio_string):
     #audio = io.BytesIO(base64.b64decode(audio_string))
     data, samplerate = sf.read(io.BytesIO(base64.b64decode(audio_string)))
     return data, samplerate

def detect_speech(audio_string):
     audio, sr = decode_audio(audio_string)
     return audio, sr
...
if __name__ == '__main__':
     ...
     y,sr = detect_speech(encoded_audio_string)
     sample_list=[y]
     seq = WavSequence(sample_list, batch_size=batch_size)
